...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        for app_name in app_names:
            ...
            visits_apiresult = Visits.objects.filter(app_name=app_name,created_at__gte=start_time_events,created_at__lte=end_time_events)
            ...
            carts_apiresult = Cart.objects.filter(app_name=app_name,created_at__gte=start_time_events,created_at__lte=end_time_events)
